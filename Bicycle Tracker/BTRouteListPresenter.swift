   ...
   func prepareRouteListItems(itemsArray: [BTTrackItem]) -> [BTRouteListItem] {
      ...
      for item in itemsArray {
         ...
         if item.heightDifference != nil {
            routeListItem.heightDifference = String.formattedHeightDifference(item.heightDifference!)
         }
         
         if item.routeComplexity != nil {
            routeListItem.routeDifficulty = item.routeComplexity
         }
         
         routeListItem.objectId = item.trackId
         routeListItem.address = item.presenterData!.placeOfRiding
         routeListItem.startAddress = item.startingAddress
         routeListItem.finishAddress = item.finishingAddress
         routeListItem.middleAddress = item.middleRouteAddress
         
         routeListItem.circleRoute = item.circleRoute
...
extension BTRouteListPresenter: BTRouteListViewOutput {
   ...
   func setContentToView(view: BTRouteListItemViewProtocol, indexPath: NSIndexPath) {
      ...
      if routeListItem.startAddress != nil {
         view.setStartAddress(routeListItem.startAddress!)
      }
      
      if routeListItem.finishAddress != nil {
         view.setFinishAddress(routeListItem.finishAddress!)
      }
      
      if routeListItem.middleAddress != nil {
         view.setMiddleAddress(routeListItem.middleAddress!)
      }
      ...
      if routeListItem.heightDifference != nil {
         view.setHeightDifference(routeListItem.heightDifference!)
      }
      ...
      if routeListItem.routeDifficulty != nil {
         view.setDifficulty(routeListItem.routeDifficulty!)
      }
      
      if routeListItem.circleRoute != nil {
         view.setCycleRoute(routeListItem.circleRoute!)
      }
   }
